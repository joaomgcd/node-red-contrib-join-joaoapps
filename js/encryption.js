...
class Encryption{
    ...
    static async encrypt(value,encryptionPassword){
        try{
            return encrypt(value,encryptionPassword);
        }catch(error){
            console.log("Couldn't encrypt",value,error);
            return value;
        }
    }
    static async decrypt(value,encryptionPassword){
        try{
            return decrypt(value,encryptionPassword);
        }catch(error){
